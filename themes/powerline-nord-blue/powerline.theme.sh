...
USER_INFO_THEME_PROMPT_COLOR="#5e81ac"
...
PYTHON_VENV_THEME_PROMPT_COLOR="#8fbcbb"
...
function __powerline_left_segment {
  ...
  if [[ "${params[1]}" == "#2e3440" || "${params[1]}" == "#3b4252" || "${params[1]}" == "#434c5e" || "${params[1]}" == "#4c566a" || "${params[1]}" == "#5e81ac" ]]; then
    text_color="#eceff4"
  fi
